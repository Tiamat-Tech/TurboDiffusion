...
The [`turbot2va`](./turbot2va) directory provides LTX-2 text-to-audio-video distillation and inference. turbot2va uses an isolated environment and does not modify the main TurboDiffusion runtime. See [`turbot2va/README.md`](./turbot2va/README.md) for installation, checkpoints, demos, and reproducibility instructions.
